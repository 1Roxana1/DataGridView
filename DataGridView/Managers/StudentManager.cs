...
namespace DataGridViewProject.Services
{
    ...
    public class StudentManager
    {
        ...
        /// <summary>
        /// Инициализировать новый экземпляр <see cref="StudentManager"/>
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public int GetCountAbove150() 
        {
            return students.Count(x => (x.InformaticsScore + x.MathScore + x.RussianScore) > 150);
        }
